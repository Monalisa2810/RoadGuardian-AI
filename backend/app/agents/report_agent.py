...
class ReportAgent:
    """Agent responsible for compiling final textual reports."""
    
    def __init__(self) -> None:
        self.client = GemmaClient()
        self.prompt_template_path = "app/prompts/report_prompt.txt"
    ...
    def _load_prompt_template(self) -> str:
        ...
        paths_to_try = [
            ...
            os.path.join(os.path.dirname(os.path.dirname(__file__)), "prompts", "report_prompt.txt")
        ]
        ...
        raise FileNotFoundError("Could not find report_prompt.txt")
    ...
    def analyze(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Failed to parse Report LLM response as JSON: {e}")
